...
from .views import CreatCity, CreatInstallationCompany, DeleteCity, DeleteInstallationCompany, ListAccounts, CreateAccount, ListCities, ListInstallationCompanies, UpdateeAccount, DeleteAccount, UpdateeCity, UpdateeInstallationCompany
