...
from .views import DetailsRawEvent, ListRawEvents, CreateDecryptedEvent, UpdateDecryptedEvent, DetailsDecryptedEvent, ListDecryptedEvents


urlpatterns = [
    path('raw_events/list', ListRawEvents.as_view(), name='rawevent_list'),
    path('raw_events/view/<int:pk>', DetailsRawEvent.as_view(), name='rawevent_detail'),
