    ...
    operations = [
        psqlextra.backend.migrations.operations.create_partitioned_model.PostgresCreatePartitionedModel(
            ...
            fields=[
                ...
                ('timer_interval_minnutes', models.IntegerField(default=0, verbose_name='دقيقة')),
                ...
                ('note_timer_interval_minnutes', models.IntegerField(default=0, verbose_name='دقيقة')),
                ('note_timer_interval_hours', models.IntegerField(default=0, verbose_name='ساعة')),
        ...
        psqlextra.backend.migrations.operations.create_partitioned_model.PostgresCreatePartitionedModel(
            ...
            options={
                ...
                'verbose_name_plural': 'الإحداث المشفرة',
                'ordering': ('-id',),
            },
            partitioning_options={
                'method': psqlextra.types.PostgresPartitioningMethod['RANGE'],
